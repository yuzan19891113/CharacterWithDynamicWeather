...
#include "UnityStandardInputRoughness.cginc"
...
inline FragmentCommonData MetallicSetup (float4 i_tex)
{
    ...
    half metallic = metallicGloss.x;
    half smoothness = metallicGloss.y; // this is 1 minus the square root of real roughness m. DOIT-XIOU  MODIFIED FOR ROUGHNESS MAPS (NOT WORKING FULLY)   orig half smoothness = metallicGloss.y;
