...
Shader "Custom/Dynamic Wetness"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //#include "../CGIncludes/myNoiseCore"  //custom
            //...
            ...
            //custom
                omega = _Wetness;
                fixed4 NoiseMapSampler = tex2D(_NoiseMap, i.uv);
                ...
                fixed4 AlbedoColorSampler = (1-MaskValue)*OriginalColor + MaskValue * WetColor;
