...
// Modifications by Matt Kiefer to make the Smoothness map act like a Roughness map instead

Shader "Custom/myStandard (Roughness setup)"
{
    Properties
    {
        ...
        [Enum(Metallic Alpha,0,Albedo Alpha,1)] _SmoothnessTextureChannel ("Roughness texture channel", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "../CGIncludes/UnityStandardCoreForwardRoughness.cginc"
        ...
        Pass
        {
            ...
            #include "../CGIncludes/UnityStandardCoreRoughness.cginc"
