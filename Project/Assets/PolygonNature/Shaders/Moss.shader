...
Shader "SyntyStudios/Moss"
{
	Properties
	{
		...
		_SnowStrength("Snow Strength", Range(0,1))=0 //Ñ©µÄÇ¿¶È
	}
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			//snow control
			float cosVal = saturate(dot(float3(0.0,1.0,0.0),i.worldNormal));
			float3 sc = float3(1.0,1.0,1.0);
			o.Albedo = lerp(albedo, sc, cosVal * _SnowStrength);
			o.Alpha = 1;
		}
