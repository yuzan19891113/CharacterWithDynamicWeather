...
namespace UnityEditor
{
    internal class yarn_StandardShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent specularText = EditorGUIUtility.TrTextContent("Noise", "Specular noise");
            ...
            public static GUIContent fabricScatterColorText = EditorGUIUtility.TrTextContent("Scatter Color", "Fabric Scatter Color");
            public static GUIContent fabricScatterScaleText = EditorGUIUtility.TrTextContent("Fabric Scatter Scale", "Fabric Scatter Scale");
            public static GUIContent anistroText = EditorGUIUtility.TrTextContent("Anisotropy", "Anisotropy");
